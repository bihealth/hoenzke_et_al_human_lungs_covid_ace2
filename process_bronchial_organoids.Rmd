---
title: "process bronchial organoids"
output: 
  html_document:
    df_print: paged
    code_folding: hide
...
results on bronchial organoids with 10X platform. 4 samples (2 donors, control+SCoV2).  alignment + quantification using `cellranger` against GRCh38+viral genome. we take all cells with at least 500 genes and mark doublets called by [scrublet](https://github.com/swolock/scrublet)

```{r get_data,fig.width=8,fig.height=4}
samples <- c("AO13_control","AO13_SCoV2","AO15_control","AO15_SCoV2")
...
```{r save_data}
saveRDS(sobj,file='data/seurat/bronchial_organoids.rds')
```
